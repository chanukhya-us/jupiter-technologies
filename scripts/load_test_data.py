...
def main():
    ...
    print("  - 36 Users (recruiters, HR, admins, marketers)")
    ...
    print("  - 8 Marketer users with profiles")
    print("  - 200+ Marketer daily activity logs")
    print()
    print("Total: 600+ records")
    print()
    ...
    with app.app_context():
        try:
            ...
            print("  - hr1, hr2 (HR)")
            print("  - admin1 (Admin)")
            print("  - marketer1, marketer2 (Marketers)")
            print("  - user7-user36 (Various roles)")
            print()
